...
extern "C"
{
    ...
    /* Lifecycle */
    MLXFaciesGAN *mlx_faciesgan_create(
        int num_layer,
        int kernel_size,
        int padding_size,
    ...
    /* Inference */
    mlx_array_t mlx_faciesgan_generate_fake(
        MLXFaciesGAN *m,
    ...
    */
    ...
    AGValue *mlx_faciesgan_generator_forward_ag(
        MLXFaciesGAN *m,
        AGValue **z_list,
        int z_count,
        const float *amp,
    ...
    int mlx_faciesgan_get_noise_amps(MLXFaciesGAN *m, float **out_amps, int *out_n);
     ...
     /* Checkpoint I/O: save/load generator/discriminator weights and shape/amp files.
    ...
    int mlx_faciesgan_optimize_discriminator_scales(
        ...
        const int *indexes,
        int n_indexes,
        MLXOptimizer **optimizers_by_scale,
    ...
    */
    int mlx_faciesgan_compute_diversity_loss(
        MLXFaciesGAN *m,
    ...
    int mlx_faciesgan_compute_masked_loss(
        MLXFaciesGAN *m,
        const mlx_array *fake,
    ...
    /* Runtime option: toggle using create-graph (higher-order) GP computation.
       Set to non-zero to use create-graph; zero to use numeric finite-diff fallback.
       Default is create-graph (1). */
