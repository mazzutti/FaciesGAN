...
def get_arguments():
    ...
    parser.add_argument(
        "--facie_num_channels", type=int, help="facie number of channels", default=1
    )
    parser.add_argument(
        "--img_color_range",
        type=int,
    ...
    parser.add_argument(
        "--min_size",
        type=int,
        help="facie minimal size at the coarser scale",
        default=12,
    )
    parser.add_argument(
        "--max_size",
    ...
    parser.add_argument(
        "--num_generated_per_real",
        type=int,
        help="Number of generated facies per real facie to use in the grid plot",
        default=5,
    )
    parser.add_argument(
        "--num_train_facies",
        type=int,
        help="Number of train facies to use in the FaciesGAN training",
        default=200,
    )
    parser.add_argument(
        "--wells",
